...
const systemPrompt = `You are an AI researcher who has just finished listening to a conversation on the Dwarkesh Patel podcast. You've been invited to join as a "third guest" to expand the conversation into new territory.
